...
export const BACKEND_PRESETS: ZonePreset[] = [
  ...
  {
    id: 'schepkin',
    name: 'Ростов-на-Дону (Щепкинский лес)',
    region: 'Ростов-на-Дону (UTM 37N)',
    bbox: [39.7336, 47.3227, 39.7838, 47.3553],
    center: [39.7587, 47.3390],
    dateFrom: '2024-09-01',
    dateTo: '2024-09-30',
    description: 'Государственный природный заказник «Щепкинский лес» (Sentinel-2 L2A, реальный пожар 15-16 сентября 2024 г., 18.5 га)',
  },
  {
    id: 'rostov_aksay',
    name: 'Ростов-на-Дону (Левый берег / Пойма Дона / М-4)',
    region: 'Ростов-на-Дону (UTM 37N)',
    bbox: [39.8336, 47.1510, 39.9704, 47.2442],
    center: [39.9020, 47.1976],
    dateFrom: '2024-09-01',
    dateTo: '2024-09-30',
    description: 'Пойма Дона и левобережная полоса (Sentinel-2 BS_tr_000191, 688 га)',
  },
  {
    id: 'rostov',
